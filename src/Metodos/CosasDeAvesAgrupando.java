...
public class CosasDeAvesAgrupando {
    ...
    public static void main(String[] args) {
     ...
     /* double peso = pedirPeso(ave);
      ...
      //vamos a imprimirla
        imprimeRacion(darSemillas(pedirPeso(ave),pedirEdad(ave)), ave);
    }
    //elige una ave
    ...
    public static int pedirEdad (String polla){
        System.out.println("¿Cuantos años tiene"+ polla + "?");
        int edad = sc.nextInt();
        return edad;
    }
