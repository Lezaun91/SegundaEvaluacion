...
public class Ejercicio21Arrays {
    ...
    //luego pasamos la baraja de arraylist
    ...
    public static int sumarPuntos(String[] jugador1){
        int puntos1 = 0;
